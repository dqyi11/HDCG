...
Feature_Spatial_Function_Child_Matches_Child( const bool& invert ) : Feature( invert ) {
...
Feature_Spatial_Function_Child_Matches_Child::
Feature_Spatial_Function_Child_Matches_Child( const Feature_Spatial_Function_Child_Matches_Child& other ) : Feature( other ) {

}

Feature_Spatial_Function_Child_Matches_Child&
Feature_Spatial_Function_Child_Matches_Child::
operator=( const Feature_Spatial_Function_Child_Matches_Child& other ) {
...
namespace h2sl_hdcg {
  ...
  operator<<( ostream& out,
              const Feature_Spatial_Function_Child_Matches_Child& other ) {
    out << "Feature_Spatial_Function_Child_Matches_Child:(invert:(" << other.invert() << "))";
    return out;
  }
