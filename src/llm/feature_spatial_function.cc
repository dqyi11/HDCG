...
Feature_Spatial_Function( const bool& invert,
                const unsigned int& spatialFunctionType ) : h2sl::Feature( invert ),
...
Feature_Spatial_Function::
Feature_Spatial_Function( const Feature_Spatial_Function& other ) : h2sl::Feature( other ),
...
namespace h2sl_hdcg {
  ...
  operator<<( ostream& out,
    ...
    out << "Feature_Spatial_Function:(invert:(" << other.invert() << ") cv:(" << other.spatial_function_type() << "))";
    return out;
  }
